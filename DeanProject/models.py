...
class degreeAuditAmendmentRequest(models.Model):
  ...
  course_num = models.DecimalField(decimal_places = 0, max_digits=10, blank = True)
  ...
  atu_course_num = models.DecimalField(decimal_places = 0, max_digits=10, blank = True)
  ...
  course_num2 = models.DecimalField(decimal_places = 0, max_digits=10, blank = True)
  ...
  atu_course_num2 = models.DecimalField(decimal_places = 0, max_digits=10, blank = True)
  ...
  course_num3 = models.DecimalField(decimal_places = 0, max_digits=10, blank = True)
  ...
  atu_course_num3 = models.DecimalField(decimal_places = 0, max_digits=10, blank = True)
  ...
  course_num4 = models.DecimalField(decimal_places = 0, max_digits=10, blank = True)
  ...
  atu_course_num4 = models.DecimalField(decimal_places = 0, max_digits=10, blank = True)
  ...
  course_num5 = models.DecimalField(decimal_places = 0, max_digits=10, blank = True)
  ...
  atu_course_num5 = models.DecimalField(decimal_places = 0, max_digits=10, blank = True)
  ...
  atu_course_num1 = models.DecimalField(decimal_places = 0, max_digits=10, blank = True)
  semester_taken1 = models.CharField(max_length = 50, blank = True)
  atu_course_prefix1B = models.CharField(max_length = 50, blank = True)
  atu_course_num1B = models.DecimalField(decimal_places = 0, max_digits=10, blank = True)
  ...
  atu_course_num2B = models.DecimalField(decimal_places = 0, max_digits=10, blank = True)
  ...
  atu_course_num3B = models.DecimalField(decimal_places = 0, max_digits=10, blank = True)
  ...
  atu_course_num6 = models.DecimalField(decimal_places = 0, max_digits=10, blank = True)

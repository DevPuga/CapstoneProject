...
class permitToRegister(models.Model):
  ...
  crn0 = models.CharField(max_length=10)
  crn1 = models.CharField(max_length=10)
  crn2 = models.CharField(max_length=10)
  crn3 = models.CharField(max_length=10)
  crn4 = models.CharField(max_length=10)
  crn5 = models.CharField(max_length=10)
  crn6 = models.CharField(max_length=10)
  crn7 = models.CharField(max_length=10)
  crn8 = models.CharField(max_length=10)
  prefix0 = models.CharField(max_length=10)
  prefix1 = models.CharField(max_length=10)
  prefix2 = models.CharField(max_length=10)
  prefix3 = models.CharField(max_length=10)
  prefix4 = models.CharField(max_length=10)
  prefix5 = models.CharField(max_length=10)
  prefix6 = models.CharField(max_length=10)
  prefix7 = models.CharField(max_length=10)
  prefix8 = models.CharField(max_length=10)
  courseNum0 = models.CharField(max_length=10)
  courseNum1 = models.CharField(max_length=10)
  courseNum2 = models.CharField(max_length=10)
  courseNum3 = models.CharField(max_length=10)
  courseNum4 = models.CharField(max_length=10)
  courseNum5 = models.CharField(max_length=10)
  courseNum6 = models.CharField(max_length=10)
  courseNum7 = models.CharField(max_length=10)
  courseNum8 = models.CharField(max_length=10)
  secNo0 = models.CharField(max_length=10)
  secNo1 = models.CharField(max_length=10)
  secNo2 = models.CharField(max_length=10)
  secNo3 = models.CharField(max_length=10)
  secNo4 = models.CharField(max_length=10)
  secNo5 = models.CharField(max_length=10)
  secNo6 = models.CharField(max_length=10)
  secNo7 = models.CharField(max_length=10)
  secNo8 = models.CharField(max_length=10)

...
class degreeAuditAmendmentRequest(models.Model):
  ...
  atu_course_number1 = models.DecimalField(decimal_places = 0, max_digits=10)
  ...
  atu_course_number2 = models.DecimalField(decimal_places = 0, max_digits=10, default = 0.0)
  semester_taken2 = models.CharField(max_length = 50, blank = True)
  ...
  atu_course_number3 = models.DecimalField(decimal_places = 0, max_digits=10, default = 0.0)
  semester_taken3 = models.CharField(max_length = 50, blank = True)
  ...
  atu_course_number4 = models.DecimalField(decimal_places = 0, max_digits=10, default = 0.0)
  comments4 = models.CharField(max_length=100, blank = True)
  atu_course_prefix5 = models.CharField(max_length = 50, blank = True)
  atu_course_number5 = models.DecimalField(decimal_places = 0, max_digits=10, default = 0.0)
  comments5 = models.CharField(max_length=100, blank = True)
  atu_course_prefix6 = models.CharField(max_length = 50, blank = True)
  atu_course_number6 = models.DecimalField(decimal_places = 0, max_digits=10, default = 0.0)

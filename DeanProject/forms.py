  ...
  def __init__(self, *args, **kwargs):
    ...
    self.helper.layout = Layout(
        Div(
            ...
            Div(
                Div('student_id_number', css_class='col'),
                Div('catalog_year', css_class='col-4'),
            css_class='row'),
            Div(
                Div('name_enrolled_under', css_class='col-8'),
         ...
         Div(
            ...
            HTML("<h6 class ='col-1'>Course Equivalent</h6>"),
            HTML("<h6 class ='col-1'>Course Substitution</h6>"),
            css_class = 'row'),
            ...
            Div(
                ...
                Div('atu_course_number',css_class = 'col-1'),
                Div('course_equivalent',css_class = 'col-1'),
                Div('course_Substitution',css_class = 'col-1'),
            css_class='row'),
            Div(
                ...
                Div('atu_course_number2',css_class = 'col-1'),
                Div('course_equivalent2',css_class = 'col-1'),
                Div('course_Substitution2',css_class = 'col-1'),
            css_class='row'),
            Div(
                ...
                Div('atu_course_number3',css_class = 'col-1'),
                Div('course_equivalent3',css_class = 'col-1'),
                Div('course_Substitution3',css_class = 'col-1'),
            css_class='row'),
            Div(
                ...
                Div('atu_course_number4',css_class = 'col-1'),
                Div('course_equivalent4',css_class = 'col-1'),
                Div('course_Substitution4',css_class = 'col-1'),
            css_class='row'),
            Div(
                ...
                Div('atu_course_number5',css_class = 'col-1'),
                Div('course_equivalent5',css_class = 'col-1'),
                Div('course_Substitution5',css_class = 'col-1'),
            css_class='row'),
            Div(
                Div('atu_course_prefix1',css_class='col-2'),
                Div('atu_course_num1',css_class='col-2'),

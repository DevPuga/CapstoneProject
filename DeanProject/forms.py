  ...
  def __init__(self, *args, **kwargs):
    ...
    self.helper.layout = Layout(
        Div(
            ...
            css_class='row'),
            Div(
                Div('crn1', css_class='col pt-1'),
                Div('prefix1', css_class='col pt-1'),
                Div('courseNum1', css_class='col pt-1'),
                Div('secNo1', css_class='col pt-1'),
            css_class='row'),
            Div(
                Div('crn2', css_class='col pt-1'),
                Div('prefix2', css_class='col pt-1'),
                Div('courseNum2', css_class='col pt-1'),
                Div('secNo2', css_class='col pt-1'),
            css_class='row'),
            Div(
                Div('crn3', css_class='col pt-1'),
                Div('prefix3', css_class='col pt-1'),
                Div('courseNum3', css_class='col pt-1'),
                Div('secNo3', css_class='col pt-1'),
            css_class='row'),
            Div(
                Div('crn4', css_class='col pt-1'),
                Div('prefix4', css_class='col pt-1'),
                Div('courseNum4', css_class='col pt-1'),
                Div('secNo4', css_class='col pt-1'),
            css_class='row'),
            Div(
                Div('crn5', css_class='col pt-1'),
                Div('prefix5', css_class='col pt-1'),
                Div('courseNum5', css_class='col pt-1'),
                Div('secNo5', css_class='col pt-1'),
            css_class='row'),
            Div(
                Div('crn6', css_class='col pt-1'),
                Div('prefix6', css_class='col pt-1'),
                Div('courseNum6', css_class='col pt-1'),
                Div('secNo6', css_class='col pt-1'),
            css_class='row'),
            Div(
                Div('crn7', css_class='col pt-1'),
                Div('prefix7', css_class='col pt-1'),
                Div('courseNum7', css_class='col pt-1'),
                Div('secNo7', css_class='col pt-1'),
            css_class='row'),
            Div(
                Div('crn8', css_class='col pt-1'),
                Div('prefix8', css_class='col pt-1'),
                Div('courseNum8', css_class='col pt-1'),
                Div('secNo8', css_class='col pt-1'),
            css_class='row'),
            Div(
